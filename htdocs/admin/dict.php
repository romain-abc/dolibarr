...
$tabname[DICT_SECTENT] = "c_sectent";
...
$tablib[DICT_SECTENT] = "DictionarySecteurEntreprise";
...
$tabsql[DICT_SECTENT] = "SELECT t.id, t.code, t.libelle, t.active FROM ".MAIN_DB_PREFIX."c_sectent as t";
...
$tabsqlsort[DICT_SECTENT] = "code ASC";
...
$tabfield[DICT_SECTENT] = "code,label";
...
$tabfieldvalue[DICT_SECTENT] = "code,label";
...
$tabfieldinsert[DICT_SECTENT] = "code,label";
